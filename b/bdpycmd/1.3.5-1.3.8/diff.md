# Comparing `tmp/bdpycmd-1.3.5.tar.gz` & `tmp/bdpycmd-1.3.8.tar.gz`
...
## Comparing `bdpycmd-1.3.5.tar` & `bdpycmd-1.3.8.tar`
...
### Comparing `bdpycmd-1.3.5/PKG-INFO` & `bdpycmd-1.3.8/PKG-INFO`
...
### Comparing `bdpycmd-1.3.5/README.md` & `bdpycmd-1.3.8/src/bdpycmd.egg-info/PKG-INFO`
...
### Comparing `bdpycmd-1.3.5/setup.cfg` & `bdpycmd-1.3.8/setup.cfg`
...
### Comparing `bdpycmd-1.3.5/src/bdpycmd/cmd/camp/assistant.py` & `bdpycmd-1.3.8/src/bdpycmd/cmd/camp/assistant.py`

 * *Files identical despite different names*

### Comparing `bdpycmd-1.3.5/src/bdpycmd/cmd/factory/base.py` & `bdpycmd-1.3.8/src/bdpycmd/cmd/factory/base.py`
...
### Comparing `bdpycmd-1.3.5/src/bdpycmd/cmd/factory/cmd.py` & `bdpycmd-1.3.8/src/bdpycmd/cmd/factory/dacmd.py`
...
### Comparing `bdpycmd-1.3.5/src/bdpycmd/pycmd.py` & `bdpycmd-1.3.8/src/bdpycmd/pycmd.py`
...
### Comparing `bdpycmd-1.3.5/src/bdpycmd.egg-info/PKG-INFO` & `bdpycmd-1.3.8/README.md`
