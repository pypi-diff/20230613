# Comparing `tmp/bdpycmd-1.2.0.tar.gz` & `tmp/bdpycmd-1.3.1.tar.gz`
...
## Comparing `bdpycmd-1.2.0.tar` & `bdpycmd-1.3.1.tar`
...
### Comparing `bdpycmd-1.2.0/PKG-INFO` & `bdpycmd-1.3.1/README.md`
