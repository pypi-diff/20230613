# Comparing `tmp/ocdskit-1.1.6.tar.gz` & `tmp/ocdskit-1.1.7.tar.gz`
...
### Comparing `ocdskit-1.1.6/docs/cli/examples.rst` & `ocdskit-1.1.7/docs/cli/examples.rst`
...
### Comparing `ocdskit-1.1.6/ocdskit/commands/package_records.py` & `ocdskit-1.1.7/ocdskit/commands/package_records.py`
...
### Comparing `ocdskit-1.1.6/ocdskit/packager.py` & `ocdskit-1.1.7/ocdskit/packager.py`
...
### Comparing `ocdskit-1.1.6/setup.cfg` & `ocdskit-1.1.7/setup.cfg`
...
### Comparing `ocdskit-1.1.6/tests/commands/cassettes/test_mapping_sheet-test_command_extension_and_extension_field_and_language.yaml` & `ocdskit-1.1.7/tests/commands/cassettes/test_mapping_sheet-test_command_extension_and_extension_field_and_language.yaml`
...
### Comparing `ocdskit-1.1.6/tests/commands/test_set_closed_codelist_enums.py` & `ocdskit-1.1.7/tests/commands/test_set_closed_codelist_enums.py`

 * *Files identical despite different names*

### Comparing `ocdskit-1.1.6/tests/commands/test_upgrade.py` & `ocdskit-1.1.7/tests/commands/test_upgrade.py`

 * *Files identical despite different names*

### Comparing `ocdskit-1.1.6/tests/fixtures/bods/components.json` & `ocdskit-1.1.7/tests/fixtures/bods/components.json`

 * *Files identical despite different names*

### Comparing `ocdskit-1.1.6/tests/fixtures/bods/person-statement.json` & `ocdskit-1.1.7/tests/fixtures/bods/person-statement.json`

 * *Files identical despite different names*

### Comparing `ocdskit-1.1.6/tests/fixtures/combine-record-packages_minimal-maximal-extensions.json` & `ocdskit-1.1.7/tests/fixtures/combine-record-packages_minimal-maximal-extensions.json`

 * *Files identical despite different names*

### Comparing `ocdskit-1.1.6/tests/fixtures/combine-release-packages_minimal-maximal-extensions.json` & `ocdskit-1.1.7/tests/fixtures/combine-release-packages_minimal-maximal-extensions.json`

 * *Files identical despite different names*

### Comparing `ocdskit-1.1.6/tests/fixtures/mapping-sheet.csv` & `ocdskit-1.1.7/tests/fixtures/mapping-sheet.csv`

 * *Files identical despite different names*

### Comparing `ocdskit-1.1.6/tests/fixtures/mapping-sheet_bods.csv` & `ocdskit-1.1.7/tests/fixtures/mapping-sheet_bods.csv`

 * *Files identical despite different names*

### Comparing `ocdskit-1.1.6/tests/fixtures/mapping-sheet_codelist.csv` & `ocdskit-1.1.7/tests/fixtures/mapping-sheet_codelist.csv`

 * *Files identical despite different names*

### Comparing `ocdskit-1.1.6/tests/fixtures/mapping-sheet_extension-field.csv` & `ocdskit-1.1.7/tests/fixtures/mapping-sheet_extension-field.csv`

 * *Files identical despite different names*

### Comparing `ocdskit-1.1.6/tests/fixtures/mapping-sheet_extension.csv` & `ocdskit-1.1.7/tests/fixtures/mapping-sheet_extension.csv`

 * *Files identical despite different names*

### Comparing `ocdskit-1.1.6/tests/fixtures/mapping-sheet_extension_extension-field.csv` & `ocdskit-1.1.7/tests/fixtures/mapping-sheet_extension_extension-field.csv`

 * *Files identical despite different names*

### Comparing `ocdskit-1.1.6/tests/fixtures/mapping-sheet_extension_extension-field_array.csv` & `ocdskit-1.1.7/tests/fixtures/mapping-sheet_extension_extension-field_array.csv`

 * *Files identical despite different names*

### Comparing `ocdskit-1.1.6/tests/fixtures/mapping-sheet_extension_extension-field_language.csv` & `ocdskit-1.1.7/tests/fixtures/mapping-sheet_extension_extension-field_language.csv`

 * *Files identical despite different names*

### Comparing `ocdskit-1.1.6/tests/fixtures/mapping-sheet_extension_extension-field_location.csv` & `ocdskit-1.1.7/tests/fixtures/mapping-sheet_extension_extension-field_location.csv`

 * *Files identical despite different names*

### Comparing `ocdskit-1.1.6/tests/fixtures/mapping-sheet_extension_extension-field_no-inherit-extension.csv` & `ocdskit-1.1.7/tests/fixtures/mapping-sheet_extension_extension-field_no-inherit-extension.csv`

 * *Files identical despite different names*

### Comparing `ocdskit-1.1.6/tests/fixtures/mapping-sheet_no-deprecated.csv` & `ocdskit-1.1.7/tests/fixtures/mapping-sheet_no-deprecated.csv`

 * *Files identical despite different names*

### Comparing `ocdskit-1.1.6/tests/fixtures/mapping-sheet_oc4ids.csv` & `ocdskit-1.1.7/tests/fixtures/mapping-sheet_oc4ids.csv`

 * *Files identical despite different names*

### Comparing `ocdskit-1.1.6/tests/fixtures/mapping-sheet_order-by.csv` & `ocdskit-1.1.7/tests/fixtures/mapping-sheet_order-by.csv`

 * *Files identical despite different names*

### Comparing `ocdskit-1.1.6/tests/fixtures/mapping-sheet_sedl.csv` & `ocdskit-1.1.7/tests/fixtures/mapping-sheet_sedl.csv`

 * *Files identical despite different names*

### Comparing `ocdskit-1.1.6/tests/fixtures/ocds-sample-data.json.gz` & `ocdskit-1.1.7/tests/fixtures/ocds-sample-data.json.gz`

 * *Files identical despite different names*

### Comparing `ocdskit-1.1.6/tests/fixtures/project-schema.json` & `ocdskit-1.1.7/tests/fixtures/project-schema.json`

 * *Files identical despite different names*

### Comparing `ocdskit-1.1.6/tests/fixtures/realdata/compile_encoding_encoding.json` & `ocdskit-1.1.7/tests/fixtures/realdata/compile_encoding_encoding.json`

 * *Files identical despite different names*

### Comparing `ocdskit-1.1.6/tests/fixtures/realdata/compiled-release-1.json` & `ocdskit-1.1.7/tests/fixtures/realdata/compiled-release-1.json`

 * *Files identical despite different names*

### Comparing `ocdskit-1.1.6/tests/fixtures/realdata/compiled-release-2.json` & `ocdskit-1.1.7/tests/fixtures/realdata/compiled-release-2.json`

 * *Files identical despite different names*

### Comparing `ocdskit-1.1.6/tests/fixtures/realdata/record-package-1-2.json` & `ocdskit-1.1.7/tests/fixtures/realdata/record-package-1-2.json`

 * *Files identical despite different names*

### Comparing `ocdskit-1.1.6/tests/fixtures/realdata/record-package-1.json` & `ocdskit-1.1.7/tests/fixtures/realdata/record-package-1.json`

 * *Files identical despite different names*

### Comparing `ocdskit-1.1.6/tests/fixtures/realdata/record-package-2.json` & `ocdskit-1.1.7/tests/fixtures/realdata/record-package-2.json`

 * *Files identical despite different names*

### Comparing `ocdskit-1.1.6/tests/fixtures/realdata/record-package_1.0.json` & `ocdskit-1.1.7/tests/fixtures/realdata/record-package_1.0.json`

 * *Files identical despite different names*

### Comparing `ocdskit-1.1.6/tests/fixtures/realdata/record-package_1.1.json` & `ocdskit-1.1.7/tests/fixtures/realdata/record-package_1.1.json`

 * *Files identical despite different names*

### Comparing `ocdskit-1.1.6/tests/fixtures/realdata/record-package_linked-releases.json` & `ocdskit-1.1.7/tests/fixtures/realdata/record-package_linked-releases.json`

 * *Files identical despite different names*

### Comparing `ocdskit-1.1.6/tests/fixtures/realdata/record-package_package.json` & `ocdskit-1.1.7/tests/fixtures/realdata/record-package_package.json`

 * *Files identical despite different names*

### Comparing `ocdskit-1.1.6/tests/fixtures/realdata/record-package_package_1.1.json` & `ocdskit-1.1.7/tests/fixtures/realdata/record-package_package_1.1.json`

 * *Files identical despite different names*

### Comparing `ocdskit-1.1.6/tests/fixtures/realdata/record-package_record-package.json` & `ocdskit-1.1.7/tests/fixtures/realdata/record-package_record-package.json`

 * *Files identical despite different names*

### Comparing `ocdskit-1.1.6/tests/fixtures/realdata/record-package_split.json` & `ocdskit-1.1.7/tests/fixtures/realdata/record-package_split.json`

 * *Files identical despite different names*

### Comparing `ocdskit-1.1.6/tests/fixtures/realdata/record-package_versioned.json` & `ocdskit-1.1.7/tests/fixtures/realdata/record-package_versioned.json`

 * *Files identical despite different names*

### Comparing `ocdskit-1.1.6/tests/fixtures/realdata/release-package-1-2.json` & `ocdskit-1.1.7/tests/fixtures/realdata/release-package-1-2.json`

 * *Files identical despite different names*

### Comparing `ocdskit-1.1.6/tests/fixtures/realdata/release-package-1.json` & `ocdskit-1.1.7/tests/fixtures/realdata/release-package-1.json`

 * *Files identical despite different names*

### Comparing `ocdskit-1.1.6/tests/fixtures/realdata/release-package-2.json` & `ocdskit-1.1.7/tests/fixtures/realdata/release-package-2.json`

 * *Files identical despite different names*

### Comparing `ocdskit-1.1.6/tests/fixtures/realdata/release-package_1.0-1.json` & `ocdskit-1.1.7/tests/fixtures/realdata/release-package_1.0-1.json`

 * *Files identical despite different names*

### Comparing `ocdskit-1.1.6/tests/fixtures/realdata/release-package_1.0-2.json` & `ocdskit-1.1.7/tests/fixtures/realdata/release-package_1.0-2.json`

 * *Files identical despite different names*

### Comparing `ocdskit-1.1.6/tests/fixtures/realdata/release-package_1.1-1.json` & `ocdskit-1.1.7/tests/fixtures/realdata/release-package_1.1-1.json`

 * *Files identical despite different names*

### Comparing `ocdskit-1.1.6/tests/fixtures/realdata/release-package_1.1-2.json` & `ocdskit-1.1.7/tests/fixtures/realdata/release-package_1.1-2.json`

 * *Files identical despite different names*

### Comparing `ocdskit-1.1.6/tests/fixtures/realdata/release-package_encoding-iso-8859-1.json` & `ocdskit-1.1.7/tests/fixtures/realdata/release-package_encoding-iso-8859-1.json`

 * *Files identical despite different names*

### Comparing `ocdskit-1.1.6/tests/fixtures/realdata/release-package_encoding-utf-8.json` & `ocdskit-1.1.7/tests/fixtures/realdata/release-package_encoding-utf-8.json`

 * *Files identical despite different names*

### Comparing `ocdskit-1.1.6/tests/fixtures/realdata/release-package_record-package.json` & `ocdskit-1.1.7/tests/fixtures/realdata/release-package_record-package.json`

 * *Files identical despite different names*

### Comparing `ocdskit-1.1.6/tests/fixtures/realdata/release-package_split.json` & `ocdskit-1.1.7/tests/fixtures/realdata/release-package_split.json`

 * *Files identical despite different names*

### Comparing `ocdskit-1.1.6/tests/fixtures/realdata/versioned-release-1.json` & `ocdskit-1.1.7/tests/fixtures/realdata/versioned-release-1.json`

 * *Files identical despite different names*

### Comparing `ocdskit-1.1.6/tests/fixtures/realdata/versioned-release-2.json` & `ocdskit-1.1.7/tests/fixtures/realdata/versioned-release-2.json`

 * *Files identical despite different names*

### Comparing `ocdskit-1.1.6/tests/fixtures/release-package-schema.json` & `ocdskit-1.1.7/tests/fixtures/release-package-schema.json`

 * *Files identical despite different names*

### Comparing `ocdskit-1.1.6/tests/fixtures/release-package_additional-contact-points.json` & `ocdskit-1.1.7/tests/fixtures/release-package_additional-contact-points.json`

 * *Files identical despite different names*

### Comparing `ocdskit-1.1.6/tests/fixtures/release-packages.jsonl` & `ocdskit-1.1.7/tests/fixtures/release-packages.jsonl`

 * *Files identical despite different names*

### Comparing `ocdskit-1.1.6/tests/fixtures/release-schema.json` & `ocdskit-1.1.7/tests/fixtures/release-schema.json`

 * *Files identical despite different names*

### Comparing `ocdskit-1.1.6/tests/fixtures/schema-strict.json` & `ocdskit-1.1.7/tests/fixtures/schema-strict.json`

 * *Files identical despite different names*

### Comparing `ocdskit-1.1.6/tests/fixtures/sedl-schema.json` & `ocdskit-1.1.7/tests/fixtures/sedl-schema.json`

 * *Files identical despite different names*

### Comparing `ocdskit-1.1.6/tests/fixtures/test-schema.json` & `ocdskit-1.1.7/tests/fixtures/test-schema.json`

 * *Files identical despite different names*

### Comparing `ocdskit-1.1.6/tests/test_combine.py` & `ocdskit-1.1.7/tests/test_combine.py`
...
### Comparing `ocdskit-1.1.6/tests/test_packager.py` & `ocdskit-1.1.7/tests/test_packager.py`

 * *Files identical despite different names*

### Comparing `ocdskit-1.1.6/tests/test_util.py` & `ocdskit-1.1.7/tests/test_util.py`
