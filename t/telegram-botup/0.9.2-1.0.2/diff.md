# Comparing `tmp/telegram_botup-0.9.2-py3-none-any.whl.zip` & `tmp/telegram_botup-1.0.2-py3-none-any.whl.zip`
...
+Comment: 
+
+Filename: botup/state_manager/__init__.py
+Comment: 
+
+Filename: botup/state_manager/base.py
+Comment: 
+
+Filename: botup/state_manager/redis.py
+Comment: 
+
+Filename: botup/widgets/__init__.py
+Comment: 
+
+Filename: botup/widgets/date_picker.py
 Comment: 
...
@@ -39,32 +123,23 @@
 ...
 Filename: tests/test_dispatcher_registration.py
 Comment: 
 
 Filename: tests/test_serializing.py
 Comment: 
 
-Filename: tests/test_state_dispatcher.py
-Comment: 
-
