# Comparing `tmp/cvxreg-0.0.7.tar.gz` & `tmp/cvxreg-0.1.0.tar.gz`
...
+gzip compressed data, was "cvxreg-0.1.0.tar", last modified: Tue Jun 13 14:01:46 2023, max compression
```

## Comparing `cvxreg-0.0.7.tar` & `cvxreg-0.1.0.tar`
...
+drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-06-13 14:01:46.283104 cvxreg-0.1.0/
+-rw-r--r--   0 runner    (1001) docker     (123)     1095 2023-06-13 14:01:36.000000 cvxreg-0.1.0/LICENSE
+-rw-r--r--   0 runner    (1001) docker     (123)     1852 2023-06-13 14:01:46.283104 cvxreg-0.1.0/PKG-INFO
+-rw-r--r--   0 runner    (1001) docker     (123)     1250 2023-06-13 14:01:36.000000 cvxreg-0.1.0/README.md
+drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-06-13 14:01:46.283104 cvxreg-0.1.0/cvxreg/
+-rw-r--r--   0 runner    (1001) docker     (123)      216 2023-06-13 14:01:36.000000 cvxreg-0.1.0/cvxreg/__init__.py
+-rw-r--r--   0 runner    (1001) docker     (123)     4473 2023-06-13 14:01:36.000000 cvxreg-0.1.0/cvxreg/base.py
+-rw-r--r--   0 runner    (1001) docker     (123)      331 2023-06-13 14:01:36.000000 cvxreg-0.1.0/cvxreg/constant.py
+drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-06-13 14:01:46.283104 cvxreg-0.1.0/cvxreg/models/
+-rw-r--r--   0 runner    (1001) docker     (123)      134 2023-06-13 14:01:36.000000 cvxreg-0.1.0/cvxreg/models/__init__.py
+-rw-r--r--   0 runner    (1001) docker     (123)     4775 2023-06-13 14:01:36.000000 cvxreg-0.1.0/cvxreg/models/_base.py
+-rw-r--r--   0 runner    (1001) docker     (123)     3380 2023-06-13 14:01:36.000000 cvxreg-0.1.0/cvxreg/models/_penalized.py
+drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-06-13 14:01:46.283104 cvxreg-0.1.0/cvxreg/utils/
+-rw-r--r--   0 runner    (1001) docker     (123)       44 2023-06-13 14:01:36.000000 cvxreg-0.1.0/cvxreg/utils/__init__.py
+-rw-r--r--   0 runner    (1001) docker     (123)     6980 2023-06-13 14:01:36.000000 cvxreg-0.1.0/cvxreg/utils/_param_check.py
+-rw-r--r--   0 runner    (1001) docker     (123)     3458 2023-06-13 14:01:36.000000 cvxreg-0.1.0/cvxreg/utils/check.py
+-rw-r--r--   0 runner    (1001) docker     (123)     1203 2023-06-13 14:01:36.000000 cvxreg-0.1.0/cvxreg/utils/extmath.py
+drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-06-13 14:01:46.283104 cvxreg-0.1.0/cvxreg.egg-info/
+-rw-r--r--   0 runner    (1001) docker     (123)     1852 2023-06-13 14:01:46.000000 cvxreg-0.1.0/cvxreg.egg-info/PKG-INFO
+-rw-r--r--   0 runner    (1001) docker     (123)      434 2023-06-13 14:01:46.000000 cvxreg-0.1.0/cvxreg.egg-info/SOURCES.txt
+-rw-r--r--   0 runner    (1001) docker     (123)        1 2023-06-13 14:01:46.000000 cvxreg-0.1.0/cvxreg.egg-info/dependency_links.txt
+-rw-r--r--   0 runner    (1001) docker     (123)        1 2023-06-13 14:01:46.000000 cvxreg-0.1.0/cvxreg.egg-info/not-zip-safe
+-rw-r--r--   0 runner    (1001) docker     (123)       54 2023-06-13 14:01:46.000000 cvxreg-0.1.0/cvxreg.egg-info/requires.txt
+-rw-r--r--   0 runner    (1001) docker     (123)        7 2023-06-13 14:01:46.000000 cvxreg-0.1.0/cvxreg.egg-info/top_level.txt
+-rw-r--r--   0 runner    (1001) docker     (123)       38 2023-06-13 14:01:46.283104 cvxreg-0.1.0/setup.cfg
+-rw-r--r--   0 runner    (1001) docker     (123)     1143 2023-06-13 14:01:36.000000 cvxreg-0.1.0/setup.py
```

### Comparing `cvxreg-0.0.7/LICENSE` & `cvxreg-0.1.0/LICENSE`

 * *Files identical despite different names*

### Comparing `cvxreg-0.0.7/PKG-INFO` & `cvxreg-0.1.0/PKG-INFO`
...
### Comparing `cvxreg-0.0.7/README.md` & `cvxreg-0.1.0/README.md`
...
### Comparing `cvxreg-0.0.7/cvxreg/base.py` & `cvxreg-0.1.0/cvxreg/base.py`
...
### Comparing `cvxreg-0.0.7/cvxreg/models/_penalized.py` & `cvxreg-0.1.0/cvxreg/models/_base.py`
...
### Comparing `cvxreg-0.0.7/cvxreg/utils/_param_check.py` & `cvxreg-0.1.0/cvxreg/utils/_param_check.py`
...
### Comparing `cvxreg-0.0.7/cvxreg/utils/check.py` & `cvxreg-0.1.0/cvxreg/utils/check.py`
...
### Comparing `cvxreg-0.0.7/cvxreg/utils/extmath.py` & `cvxreg-0.1.0/cvxreg/utils/extmath.py`
...
### Comparing `cvxreg-0.0.7/cvxreg.egg-info/PKG-INFO` & `cvxreg-0.1.0/cvxreg.egg-info/PKG-INFO`
...
### Comparing `cvxreg-0.0.7/setup.py` & `cvxreg-0.1.0/setup.py`
