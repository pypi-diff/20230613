# Comparing `tmp/fullask-rest-framework-0.1.7.tar.gz` & `tmp/fullask-rest-framework-0.1.8.tar.gz`
...
## Comparing `fullask-rest-framework-0.1.7.tar` & `fullask-rest-framework-0.1.8.tar`
...
### Comparing `fullask-rest-framework-0.1.7/LICENSE` & `fullask-rest-framework-0.1.8/LICENSE`

 * *Files identical despite different names*

### Comparing `fullask-rest-framework-0.1.7/PKG-INFO` & `fullask-rest-framework-0.1.8/PKG-INFO`
...
### Comparing `fullask-rest-framework-0.1.7/README.md` & `fullask-rest-framework-0.1.8/README.md`

 * *Files identical despite different names*

### Comparing `fullask-rest-framework-0.1.7/docs/Makefile` & `fullask-rest-framework-0.1.8/docs/Makefile`

 * *Files identical despite different names*

### Comparing `fullask-rest-framework-0.1.7/docs/docfiles/conf.py` & `fullask-rest-framework-0.1.8/docs/docfiles/conf.py`

 * *Files identical despite different names*

### Comparing `fullask-rest-framework-0.1.7/docs/docfiles/contributing.rst` & `fullask-rest-framework-0.1.8/docs/docfiles/contributing.rst`

 * *Files identical despite different names*

### Comparing `fullask-rest-framework-0.1.7/docs/docfiles/installation.rst` & `fullask-rest-framework-0.1.8/docs/docfiles/installation.rst`

 * *Files identical despite different names*

### Comparing `fullask-rest-framework-0.1.7/docs/make.bat` & `fullask-rest-framework-0.1.8/docs/make.bat`

 * *Files identical despite different names*

### Comparing `fullask-rest-framework-0.1.7/fullask_rest_framework/cli.py` & `fullask-rest-framework-0.1.8/fullask_rest_framework/cli.py`

 * *Files identical despite different names*

### Comparing `fullask-rest-framework-0.1.7/fullask_rest_framework/contrib/admin/templates/login_form.html` & `fullask-rest-framework-0.1.8/fullask_rest_framework/contrib/admin/templates/login_form.html`

 * *Files identical despite different names*

### Comparing `fullask-rest-framework-0.1.7/fullask_rest_framework/contrib/admin/templates/static/loigin_form.css` & `fullask-rest-framework-0.1.8/fullask_rest_framework/contrib/admin/templates/static/loigin_form.css`

 * *Files identical despite different names*

### Comparing `fullask-rest-framework-0.1.7/fullask_rest_framework/createproject_template/project_template/factory.txt` & `fullask-rest-framework-0.1.8/fullask_rest_framework/createproject_template/project_template/factory.txt`

 * *Files identical despite different names*

### Comparing `fullask-rest-framework-0.1.7/fullask_rest_framework/factory/app_factory.py` & `fullask-rest-framework-0.1.8/fullask_rest_framework/factory/app_factory.py`

 * *Files identical despite different names*

### Comparing `fullask-rest-framework-0.1.7/fullask_rest_framework/factory/extensions.py` & `fullask-rest-framework-0.1.8/fullask_rest_framework/factory/extensions.py`

 * *Files identical despite different names*

### Comparing `fullask-rest-framework-0.1.7/fullask_rest_framework/orm/sqlalchemy/mixins.py` & `fullask-rest-framework-0.1.8/fullask_rest_framework/orm/sqlalchemy/mixins.py`

 * *Files identical despite different names*

### Comparing `fullask-rest-framework-0.1.7/fullask_rest_framework/repositories/crud.py` & `fullask-rest-framework-0.1.8/fullask_rest_framework/repositories/crud.py`

 * *Files identical despite different names*

### Comparing `fullask-rest-framework-0.1.7/fullask_rest_framework/repositories/sqlalchemy.py` & `fullask-rest-framework-0.1.8/fullask_rest_framework/repositories/sqlalchemy.py`

 * *Files identical despite different names*

### Comparing `fullask-rest-framework-0.1.7/fullask_rest_framework/schemas/fields.py` & `fullask-rest-framework-0.1.8/fullask_rest_framework/schemas/fields.py`

 * *Files identical despite different names*

### Comparing `fullask-rest-framework-0.1.7/fullask_rest_framework/schemas/pagination.py` & `fullask-rest-framework-0.1.8/fullask_rest_framework/schemas/pagination.py`

 * *Files identical despite different names*

### Comparing `fullask-rest-framework-0.1.7/fullask_rest_framework/schemas/sorting.py` & `fullask-rest-framework-0.1.8/fullask_rest_framework/schemas/sorting.py`

 * *Files identical despite different names*

### Comparing `fullask-rest-framework-0.1.7/fullask_rest_framework/utils/jwt.py` & `fullask-rest-framework-0.1.8/fullask_rest_framework/utils/jwt.py`

 * *Files identical despite different names*

### Comparing `fullask-rest-framework-0.1.7/fullask_rest_framework.egg-info/PKG-INFO` & `fullask-rest-framework-0.1.8/fullask_rest_framework.egg-info/PKG-INFO`
...
### Comparing `fullask-rest-framework-0.1.7/fullask_rest_framework.egg-info/SOURCES.txt` & `fullask-rest-framework-0.1.8/fullask_rest_framework.egg-info/SOURCES.txt`

 * *Files identical despite different names*

### Comparing `fullask-rest-framework-0.1.7/pyproject.toml` & `fullask-rest-framework-0.1.8/pyproject.toml`
...
+version = "0.1.8"
 ...
 readme = "README.md"
 packages = [{ include = "fullask_rest_framework" }]
...
### Comparing `fullask-rest-framework-0.1.7/setup.py` & `fullask-rest-framework-0.1.8/setup.py`
...
### Comparing `fullask-rest-framework-0.1.7/tests/repositories/test_sqlalchemy_repository.py` & `fullask-rest-framework-0.1.8/tests/repositories/test_sqlalchemy_repository.py`
