# Comparing `tmp/pitop.battery-0.31.0.post3.tar.gz` & `tmp/pitop.battery-0.31.0.post4.tar.gz`
...
## Comparing `pitop.battery-0.31.0.post3.tar` & `pitop.battery-0.31.0.post4.tar`
...
### Comparing `pitop.battery-0.31.0.post3/PKG-INFO` & `pitop.battery-0.31.0.post4/PKG-INFO`
...
### Comparing `pitop.battery-0.31.0.post3/pitop/battery/battery.py` & `pitop.battery-0.31.0.post4/pitop/battery/battery.py`

 * *Files identical despite different names*

### Comparing `pitop.battery-0.31.0.post3/pitop.battery.egg-info/PKG-INFO` & `pitop.battery-0.31.0.post4/pitop.battery.egg-info/PKG-INFO`
...
### Comparing `pitop.battery-0.31.0.post3/setup.py` & `pitop.battery-0.31.0.post4/setup.py`
