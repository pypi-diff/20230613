# Comparing `tmp/pipeline_ai-0.5.0b4.tar.gz` & `tmp/pipeline_ai-0.5.0b5.tar.gz`
...
### Comparing `pipeline_ai-0.5.0b4/pipeline/docker/__init__.py` & `pipeline_ai-0.5.0b5/pipeline/docker/__init__.py`
