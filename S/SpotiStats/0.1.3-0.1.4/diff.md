# Comparing `tmp/SpotiStats-0.1.3.tar.gz` & `tmp/SpotiStats-0.1.4.tar.gz`
...
## Comparing `SpotiStats-0.1.3.tar` & `SpotiStats-0.1.4.tar`
...
### Comparing `SpotiStats-0.1.3/PKG-INFO` & `SpotiStats-0.1.4/PKG-INFO`
...
### Comparing `SpotiStats-0.1.3/SpotiStats/__main__.py` & `SpotiStats-0.1.4/SpotiStats/__main__.py`

 * *Files identical despite different names*

### Comparing `SpotiStats-0.1.3/SpotiStats/spotify.py` & `SpotiStats-0.1.4/SpotiStats/spotify.py`

 * *Files identical despite different names*

### Comparing `SpotiStats-0.1.3/SpotiStats.egg-info/PKG-INFO` & `SpotiStats-0.1.4/SpotiStats.egg-info/PKG-INFO`
